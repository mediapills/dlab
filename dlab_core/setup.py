...
class ParametersBuilder:
    ...
    def _read_file(name):
        ...
        if not os.path.isfile(name):
            raise DLabSetupException("No such file or directory: '{}'".format(name))
        ...
        try:
            ...
            if hasattr(e, 'filename'):
                e = DLabSetupException("{}: '{}'".format(e.strerror, e.filename))
            raise e
    ...
    def set_version(self):
        ...
        try:
            ...
            raise DLabSetupException("name '{}' is not defined".format('__version__'))
