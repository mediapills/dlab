...
from dlab.domain.entities import LogMessage
from ..logger import (
    AbstractHandler, AbstractLoggingLogger, AbstractLogBuilder, LoggingLogger,
...
class AWSLogBuilder(AbstractLogBuilder):
    ...
    def add_cw_handler(self):
        ...
        handler.setLevel(AbstractLoggingLogger.LEVEL_DEBUG)
